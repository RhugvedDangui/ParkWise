      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4 ml-6">
          ...
          <button
            ...
            className="relative w-14 h-7 bg-gray-200 dark:bg-gray-700 rounded-full transition-all duration-500 hover:scale-110 group"
          >
            <div className={`absolute top-1 left-1 w-5 h-5 bg-white dark:bg-cyan-400 rounded-full shadow-md transition-all duration-500 flex items-center justify-center ${
